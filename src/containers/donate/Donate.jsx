    ...
    return (
      <Page contentClassName="donate" constrain={true}>
        ...
        <p className="donate__info">
          If you’ve spent any time around the Omni team, there’s one thing you will notice: <strong>we love <a href="http://opensource.org/docs/osd" target="_blank">open source</a>, and we love the community.</strong>
        ...
        <div className="donate__button-container">
          <strong>LTC:</strong> LaS4P1Nff8eG7p5fmQ9fGuFPovZuUGyhEm
        </div>
        <div className="donate__button-container">
          <strong>BTC:</strong> 18Q3SJUkz1jxNrrWxjLWNR8i8Ppj185CCk
        </div>
        <div className="donate__button-container">
          <strong>ETC:</strong> 0x4e49D75F444E26532fd3D903D8e1F21c9559F0F6
        </div>
      </Page>
    );
  }
